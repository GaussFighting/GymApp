function Profile() {
  return (
    <div>
      <strong>he standard</strong> <b>Lorem Ipsum passage</b>, used since the
      <em>1500s "Lorem </em>ipsum <i>dolor sit amet,</i> consectetur{" "}
      ...
      natus error sit voluptatem accusantium<range> asaaaaaaaaaaf </range>
